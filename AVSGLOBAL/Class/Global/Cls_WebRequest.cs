...
public class Cls_KeyValue{
    ...
    /// </summary>
    /// <value></value>
    public List<Cls_KeyValue> Parameters{get; set;}
...
public static async Task<string> SendRequest(Cls_WebRequestOption options)
{
    ...
    Mdl_User User = new Mdl_User();
            ...
            switch(options.ActionType)
            {
                ...
                case Enm_ActionTypes.Post: //todo post metodu yapılacak!
 ...
 /// <param name="url"></param>
 /// <returns></returns>
 public static async Task<string> PostRequest(string url,  List<Cls_KeyValue> Parameters)
    {
        var json ="";                     
                    client.BaseAddress = new Uri(Cls_Settings.MAIN_WEB_SERVICE);                 
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));                  
 ...
 /// <param name="url"></param>
 /// <returns></returns>
 public static async Task<string> PostRequest(string url,  List<Cls_KeyValue> Parameters, string token)
    {
        var json ="";
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);                 
                    client.BaseAddress = new Uri(Cls_Settings.MAIN_WEB_SERVICE);                 
